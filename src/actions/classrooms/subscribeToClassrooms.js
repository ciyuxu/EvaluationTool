...
export const SUBSCRIBED_TO_CLASSROOMS_SERVICE = 'SUBSCRIBED_TO_CLASSROOMS_SERVICE'
...
export default () => {
  return (dispatch) => {
    classrooms.on('created', (classroom) => { dispatch(createdClassroom(classroom)) })
    classrooms.on('updated', (classroom) => { dispatch(updatedClassroom(classroom)) })
    classrooms.on('patched', (classroom) => { dispatch(updatedClassroom(classroom)) })
    classrooms.on('removed', (classroom) => { dispatch(removedClassroom(classroom)) })
