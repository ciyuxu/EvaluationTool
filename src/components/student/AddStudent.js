...
class AddStudent extends PureComponent {
  constructor(props) {
    ...
    this.state = {
      fullName: "",
      photo:
        "http://www.clker.com/cliparts/3/0/9/a/1358885275951429608Gray%20Avatar.svg.med.png"
    };
  }
  ...
  validate(student) {
    ...
    if (!fullName || fullName === "")
      errors.fullName = "Please type in some name!";
...
addAStudent.propTypes = { signedIn: PropTypes.bool };
