...
class EvaluationForm extends PureComponent {
  constructor(props) {
    ...
    this.handleChange = (event, index, currentColor) =>
...
const mapStateToProps = ({ currentStudent, currentUser, student }) => ({
  currentStudent,
  currentUser,
  student
});

export default connect(mapStateToProps, { evaluateStudent, getCurrentStudent })(
  EvaluationForm
);
